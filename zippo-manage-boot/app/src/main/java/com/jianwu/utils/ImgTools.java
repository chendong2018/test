...
public class ImgTools {
     ...
     * @throws IOException
     */
    public static void thumbnail_w_h( BufferedImage bi, int width, int height,
     ...
     * @throws IOException
     */
    public static void thumbnail(BufferedImage BI, int width, int height,
                                 OutputStream out) throws IOException {
    ...
    public static BufferedImage thumbnailFile(BufferedImage BI, int width, int height ) throws IOException {
        Image image = BI.getScaledInstance(width, height, Image.SCALE_SMOOTH);
     ...
     * @throws IOException
     */
    public static BufferedImage thumbnail_w_hImage( BufferedImage bi, int width, int height ) throws IOException {
        double srcWidth = bi.getWidth(); // 源图宽度
        double srcHeight = bi.getHeight(); // 源图高度
        double scale = 1;
        ...
        BufferedImage tag = thumbnailFile(bi, (int) (srcWidth * scale), (int) (srcHeight * scale));
        return tag;
    }
    ...
    public static void main(String[] args) throws IOException {
        File img = new File("C:\\Users\\jianwu\\Desktop\\ces.png");
