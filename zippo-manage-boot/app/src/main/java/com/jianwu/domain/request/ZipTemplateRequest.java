...
public class ZipTemplateRequest implements Serializable {
    /**
     * 模板
     */
    private Integer id;
    ...
    private Date time;//前端用的时间戳

    private Date createTime;

    private Date updateTime;

    private List<ZipTemplateDetailsRequest> list;
    ...
    public List<ZipTemplateDetailsRequest> getList() {
        return list;
    }

    public void setList(List<ZipTemplateDetailsRequest> list) {
        this.list = list;
    }
